package ru.borsch.simple.config;
...
@Configuration
@EnableJpaRepositories(basePackages = "ru.borsch.simple.repository",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "ru.borsch.simple.model" });
